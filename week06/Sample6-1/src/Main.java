...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("북한 면적 :%,d km \n", NorthKorea);
        System.out.printf("미국의 면적 :%,d km \n", USA);
        System.out.printf("일번의 면적 :%,d km \n", JAPAN);

        System.out.printf("북한 우리나라에 비해 %.2f 배임\n", temp1 );
        System.out.printf("미국우리나라에 비해 %.2f 배임\n",temp2);
        System.out.printf("일본 우리나라에 비해 %.2f 배임\n",temp3);
